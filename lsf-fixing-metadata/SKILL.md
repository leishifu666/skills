---
name: lsf-fixing-metadata
title: 技能：LSF Fixing Metadata
description: 检查并修复 HTML 元数据，包括页面标题、描述、规范链接、Open Graph、社交分享卡片、站点图标、JSON-LD 结构化数据和 robots
  指令。适用于 SEO、分享预览和新页面发布。
license: MIT
metadata:
