...
Heading semantics and outline quality belong to `lsf-better-accessibility`. Pick the element from the document structure, then use this skill to make that structure visually legible. Never pick a heading element for its browser-default size.
