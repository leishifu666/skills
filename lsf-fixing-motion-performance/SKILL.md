---
name: lsf-fixing-motion-performance
title: LSF Fixing Motion 性能
description: 检查并修复动画性能问题，包括布局抖动、合成器属性、滚动关联动画和模糊效果。适用于动画卡顿、过渡掉帧及 CSS 或 JavaScript 动效性能审查。
---
