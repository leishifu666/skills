...
Breaks land in `lsf-better-typography` for wrapping and truncation, `lsf-better-layout` where the container has no room and `lsf-better-writing` where the source copy is the problem.
...
Breaks land in `lsf-better-typography`; spatial mirroring lands in `lsf-better-layout`.
...
Zero-item breaks land in `lsf-better-writing` for the empty state and `lsf-better-layout` for the region; the rest land in `lsf-better-layout`.
...
Breaks land in `lsf-better-layout`.
...
Breaks land in `lsf-better-accessibility`; purely visual state polish lands in `lsf-better-ui`.
...
Dark-mode breaks land in `lsf-better-colors`; zoom and motion land in `lsf-better-accessibility`.
