---
name: lsf-space-wechat-layout
description: LSF｜微信公众号排版。Use when the user asks to turn an article, Markdown draft,
  longform post, essay, newsletter, review, or Chinese article into a WeChat Official
  Account-ready HTML layout with local preview, selectable Claude/OpenAI/Google-inspired
  styles, and a button to copy rich HTML for pasting into the WeChat editor.
title: LSF 公众号排版
metadata:
  github_url: https://github.com/SpaceZephyr/creator-buddy
  github_hash: edf46c567ff54b72ee2157d06f3a02dbd67aaa9c
  github_path: gzh-Skills/space-wechat-layout
  upstream_name: space-wechat-layout
...
> **LSF 汉化版**：上游模块名 `space-wechat-layout`，本机调用名 `lsf-space-wechat-layout`。
