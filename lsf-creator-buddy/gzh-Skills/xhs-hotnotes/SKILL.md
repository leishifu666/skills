---
name: lsf-xiaohongshu-search
description: LSF｜小红书热门笔记搜索工具，支持关键词搜索获取热门内容数据，基于数据评分排序推荐热门笔记，助力创作者发现热门趋势、获取创作灵感。仅在主Agent中执行,不派发给子Agent。
dependency:
  python: []
  system: null
title: LSF 小红书搜索
metadata:
  ...
  github_path: gzh-Skills/xhs-hotnotes
  upstream_name: xiaohongshu-search
...
> **LSF 汉化版**：上游模块名 `xiaohongshu-search`，本机调用名 `lsf-xiaohongshu-search`。
