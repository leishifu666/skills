---
name: lsf-baokuan-title-generator
description: LSF｜科技/AI/互联网领域的公众号 10 万+ 爆款标题生成器。输入一篇文章、一段内容或一个主题，先建内容简报，再按多种方法产出多个候选标题，逐个评分、标风险、按用途分角色推荐，并给
  A/B 测试建议。当用户说"起标题""想个爆款标题""这篇文章叫什么好""标题优化""标题改写""多组标题""标题评分""10万+标题"时触发。方法论提炼自 100
  篇真实科技类爆文标题。
title: LSF 公众号爆款标题
metadata:
  github_url: https://github.com/SpaceZephyr/creator-buddy
  github_hash: edf46c567ff54b72ee2157d06f3a02dbd67aaa9c
  github_path: gzh-Skills/baokuan-title-generator
  upstream_name: baokuan-title-generator
...
> **LSF 汉化版**：上游模块名 `baokuan-title-generator`，本机调用名 `lsf-baokuan-title-generator`。
