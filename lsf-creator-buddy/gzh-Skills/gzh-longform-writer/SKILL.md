---
name: lsf-gzh-longform-writer
description: LSF｜公众号长文写作（1500–4000 字）。先诊断作者手上已有什么（一个念头 / 一堆素材 / 半篇草稿 / 一份大纲 / 一篇不满意的成稿），再路由到对应的六种写法之一，产出成稿并过公众号专属质检。当用户说"写篇公众号""帮我写文章""这个主题怎么写""我有一堆素材不知道怎么组织""帮我扩写""这篇改一下""写不下去了""长文""深度文"时触发。
title: LSF 公众号长文写作
metadata:
  github_url: https://github.com/SpaceZephyr/creator-buddy
  github_hash: edf46c567ff54b72ee2157d06f3a02dbd67aaa9c
  github_path: gzh-Skills/gzh-longform-writer
  upstream_name: gzh-longform-writer
...
> **LSF 汉化版**：上游模块名 `gzh-longform-writer`，本机调用名 `lsf-gzh-longform-writer`。
