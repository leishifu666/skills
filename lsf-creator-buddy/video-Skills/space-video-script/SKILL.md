---
name: lsf-space-video-script
description: LSF｜视频口播脚本撰写，两大特色——(1) 去 AI 味，把书面/AI 腔改成能念出口的真人口语；(2) 把模糊想法逼成一份精确到秒的分镜脚本（每个镜头讲什么、怎么呈现、停多久、怎么切）。当用户说「写口播脚本」「这段太
  AI 了改成人话」「口播稿」「分镜脚本」「精确到秒」「script」「改成能念的」时触发。输入可以是选题正文、一段草稿，或一句模糊描述。
title: LSF 视频脚本
metadata:
  github_url: https://github.com/SpaceZephyr/creator-buddy
  github_hash: edf46c567ff54b72ee2157d06f3a02dbd67aaa9c
  github_path: video-Skills/space-video-script
  upstream_name: space-video-script
...
> **LSF 汉化版**：上游模块名 `space-video-script`，本机调用名 `lsf-space-video-script`。
