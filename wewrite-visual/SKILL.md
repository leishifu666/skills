---
name: lsf-wewrite-visual
description: 'LSF｜WeWrite 视觉模块：为公众号文章生成封面和必要的内文配图，或只交付提示词。触发词：
...
metadata:
  ...
  github_path: skills/wewrite-visual
  upstream_name: wewrite-visual
...
> **LSF 汉化版**：上游模块名 `wewrite-visual`，本机调用名 `lsf-wewrite-visual`。
