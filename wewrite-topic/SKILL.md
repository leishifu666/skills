---
name: lsf-wewrite-topic
description: 'LSF｜WeWrite 选题模块：抓取全网热点 + 垂类高频需求 + 历史表现分析 + 搜索需求，为公众号
...
metadata:
  ...
  github_path: skills/wewrite-topic
  upstream_name: wewrite-topic
...
> **LSF 汉化版**：上游模块名 `wewrite-topic`，本机调用名 `lsf-wewrite-topic`。
