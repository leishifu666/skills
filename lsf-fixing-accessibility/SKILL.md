---
name: lsf-fixing-accessibility
title: 技能：LSF Fixing Accessibility
description: 检查并修复 HTML 无障碍问题，包括 ARIA 标签、键盘导航、焦点管理、颜色对比度和表单错误。适用于交互控件、表单、对话框及 WCAG
  合规审查。
---
...
- `/lsf-fixing-accessibility`
  Apply these constraints to any UI work in this conversation.

- `/lsf-fixing-accessibility <file>`
