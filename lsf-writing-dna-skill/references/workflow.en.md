...
Clean AI writing tells from the finished draft using the rules in `skills/lsf-lieflat-less-ai-tone/`. It rewrites against an explicit whitelist, leaves unmatched text untouched, and does not restructure the piece.
