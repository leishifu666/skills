...
规则的依据是触发标记可定位，不是频率高低。各条规则的实测数据、被推翻的预设和测量脚本见研究仓库 [lsf-lieflat-less-ai-tone](https://github.com/larashero3-dotcom/lieflat-less-ai-tone)。
