---
name: lsf-better-layout
title: 技能：LSF Better Layout
description: Web 界面的布局结构。用于组织页面或组件、决定小尺寸下的折叠方式，或审查前端布局代码。触发词：布局、间距、对齐、分组、留白、视觉层级、阅读顺序、渐进披露、断点、容器查询、安全区域、全出血、页面边距、RTL
  布局、逻辑属性。
---
...
Hit areas and focus behavior belong to `lsf-better-accessibility`. Radius, shadows and animation belong to `lsf-better-ui`. Line length and text spacing belong to `lsf-better-typography`.
