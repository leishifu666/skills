...
Ported from the base skill's forge/tests/test_geodesic_skinning.py. Its subject moved to this plugin as
`tools/rig_geodesic_skinning.py` (PLUGIN_CONTRACT.md §4, §8), so the assertions that pin that module's
...
from rig_geodesic_skinning import (  # noqa: E402
    bind,
    euclidean_bind,
    geodesic_field,
    VoxelGrid,
