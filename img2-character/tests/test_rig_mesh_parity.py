...
Ported from the base skill's forge/tests/test_mesh_parity.py. Its subject moved to this plugin as
`tools/rig_mesh_parity.py` (PLUGIN_CONTRACT.md §4, §8), so the assertions that pin that module's
...
from rig_mesh_parity import (  # noqa: E402
    FROZEN_ATTRIBUTES,
    FROZEN_BUFFERS,
    INDEX_KEY,
