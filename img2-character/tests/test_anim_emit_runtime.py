#!/usr/bin/env python3
"""Tests for the Stage R5 runtime emitter (tools/anim_emit_runtime.py).
...
Ported from the base skill's forge/tests/test_emit_animation_runtime.py. Its subject moved to this plugin as
`tools/anim_emit_runtime.py` (PLUGIN_CONTRACT.md §4, §8), so the assertions that pin that module's
...
from anim_emit_runtime import (  # noqa: E402
    BINDING_EPSILON,
