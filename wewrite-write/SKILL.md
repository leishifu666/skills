---
name: lsf-wewrite-write
description: 'LSF｜WeWrite 写作模块：在公众号选题明确后完成文章任务书、主张与证据、素材和初稿。由主流程调用，
...
metadata:
  ...
  github_path: skills/wewrite-write
  upstream_name: wewrite-write
...
> **LSF 汉化版**：上游模块名 `wewrite-write`，本机调用名 `lsf-wewrite-write`。
