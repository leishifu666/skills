---
name: lsf-wewrite-rewrite
description: 'LSF｜WeWrite 多平台改写模块：把一篇公众号文章（或指定源稿）内容级真改写成其他平台版本，
...
metadata:
  ...
  github_path: skills/wewrite-rewrite
  upstream_name: wewrite-rewrite
...
> **LSF 汉化版**：上游模块名 `wewrite-rewrite`，本机调用名 `lsf-wewrite-rewrite`。
