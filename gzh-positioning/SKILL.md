---
name: lsf-gzh-positioning
description: LSF｜公众号定位分析 + 三件套设计（账号简介 / 关注后自动回复 / 自定义菜单）。先通过分层访谈和历史文章反推，收敛出一句话定位，再派生出可直接粘贴进公众号后台的三份内容，全部带字数校验。当用户说"公众号定位""账号简介怎么写""功能介绍""公众号介绍""关注后回复""欢迎语""自动回复""菜单怎么设计""菜单栏""公众号装修""新号怎么起步""号没人关注"时触发。
title: LSF 公众号定位
metadata:
  github_url: https://github.com/SpaceZephyr/creator-buddy
  github_hash: edf46c567ff54b72ee2157d06f3a02dbd67aaa9c
  github_path: gzh-Skills/gzh-positioning
  upstream_name: gzh-positioning
...
> **LSF 汉化版**：上游模块名 `gzh-positioning`，本机调用名 `lsf-gzh-positioning`。
