...
最多 14 张参考图 (6 张高保真)。跨场景锁定身份。

> 如果角色来自 [character-identity-design.md](character-identity-design.md),其身份档案中的全部锚点默认永久锁定,包括服装、发型/毛型/叶序、配饰、颜色和固定表情。本文件中的换装、换表情等变化只有在用户明确授权对应变化时才可使用;未被授权的锚点继续保持不变。
...
关键短语: "Keep facial features exactly the same as Image 1"
