---
name: lsf-wewrite-publish
description: 'LSF｜WeWrite 排版发布模块：把 Markdown 做成微信预览，或在用户明确授权后推入公众号草稿箱；
...
title: LSF 公众号排版发布
metadata:
  github_url: https://github.com/imraywang/wewrite
  github_hash: a363da0d92d30fc442aba6549d1a8824ebb0c115
  github_path: skills/wewrite-publish
  upstream_name: wewrite-publish
...
> **LSF 汉化版**：上游模块名 `wewrite-publish`，本机调用名 `lsf-wewrite-publish`。
