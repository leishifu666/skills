---
name: lsf-wewrite-learn
description: 'LSF｜WeWrite 自学习模块：从用户的人工修改中学习写作偏好（playbook 飞轮）、导入范文建风格库、
...
metadata:
  ...
  github_path: skills/wewrite-learn
  upstream_name: wewrite-learn
...
> **LSF 汉化版**：上游模块名 `wewrite-learn`，本机调用名 `lsf-wewrite-learn`。
