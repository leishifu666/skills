---
name: lsf-wewrite-review
description: 'LSF｜WeWrite 编辑审稿模块：核对任务、事实来源、观点和实用性，必要时直接改稿，只有通过编辑门槛
...
metadata:
  ...
  github_path: skills/wewrite-review
  upstream_name: wewrite-review
...
> **LSF 汉化版**：上游模块名 `wewrite-review`，本机调用名 `lsf-wewrite-review`。
