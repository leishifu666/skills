---
name: lsf-wewrite-stats
description: 'LSF｜WeWrite 数据复盘模块：拉取微信公众号文章的阅读/分享/点赞数据，回填历史记录并给出
...
metadata:
  ...
  github_path: skills/wewrite-stats
  upstream_name: wewrite-stats
...
> **LSF 汉化版**：上游模块名 `wewrite-stats`，本机调用名 `lsf-wewrite-stats`。
